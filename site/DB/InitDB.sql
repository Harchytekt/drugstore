...
('Sedergine comprimés effervescents', '325 mg; 500mg; 1 g', 'La posologie doit être réduite chez les patients qui consomment beaucoup d’alcool.<br>En cas de grossesse, demandez conseil à votre médecin avant de prendre tout médicament.
DAFALGAN 500 mg peut être pris pendant les derniers mois de la grossesse.', 'http://bijsluiters.fagg-afmps.be/DownloadLeafletServlet?id=118997'),
('Sinutab comprimés', '500 mg;60 mg', 'Le produit doit être utilisé avec prudence en cas d’atteinte des reins et/ou du foie (dans de tels cas, il est conseillé de réduire la dose) ainsi que d’affection cardiaque.<br>Si vous êtes enceinte ou que vous allaitez, si vous pensez être enceinte ou planifiez une grossesse, demandez conseil à votre médecin ou à votre pharmacien avant de prendre ce médicament.
', 'http://bijsluiters.fagg-afmps.be/DownloadLeafletServlet?id=120972');
